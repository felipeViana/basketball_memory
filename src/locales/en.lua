...
local function locales()
  return {
    ...
    ['2.1'] = 'Good morning citizens of our beautiful city Cérebro, where memories become history. ' ..
      'Today there will be registration for the virtual memory game championship that I decided to hold here at the city.',
