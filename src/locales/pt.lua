...
local function locales()
  return {
    ...
    ['3-2.6-1'] = 'Enquanto o jovem garoto corre pra pegar o dinheiro, Bob conversa com o Criador ...',
    ...
    ['3-2.10'] = 'Qual?',
    ['3-2.11'] = 'Dificulte nossa vida no campeonato, pois acredito que quanto mais ele trabalhar a memória dele, melhor vai ser para fazer seu cérebro funcionar normalmente. Ah, também queria que sempre que ele passar por um lugar diferente no campeonato tenha uma foto na parede que o faça lembrar de seu passado. Eu estou com as fotos aqui, posso te entregar. Você poderia ampliar e colocá-las nas paredes?',
