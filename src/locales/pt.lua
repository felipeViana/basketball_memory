...
local function locales()
  return {
    ...
    ['2.1'] = 'Bom dia cidadãos da nossa belíssima cidade Cérebro, onde memórias se tornam história. Hoje será realizada a inscrição para o campeonato de jogo da memória virtual que decidi realizar aqui na cidade.',
    ['2.2'] = 'As vagas são limitadas, só temos 16. Como o local é um ginásio nós teremos muito espaço para assistir ao campeonato. Vocês só terão que pagar 10 cérebros para entrar e se divertir lá dentro. Mas agora que temos bastante gente aqui deixa eu começar a explicar como será.',
    ['2.3'] = 'Os participantes irão se inscrever, em seguida nós faremos um sorteio e serão definidos chaves de 8 jogadores. De cada chave 4 se classificam para as quartas de final e todas as partidas serão definidas por sorteio. Neste campeonato os jogadores irão se enfrentar um contra um. Serão 4 estilos de jogos da memória mas cada estilo só vai mudar depois de cada classificação. Ou seja, é um estilo para as oitavas de final, outro para as quartas de final, outro para as semifinais e outro para a final. Cada estilo de jogo terá 5 níveis nos quais os jogadores irão se enfrentar. Antes de cada partida será explicado melhor como funcionará como modo de jogo.',
    ['2.4'] = 'Então quem estiver interessado apareça no ginásio de memorial esportivo hoje às 10 horas da manhã pois é o horário de início da inscrição e só vai até acabar as vagas. Para quem for assistir ao campeonato eu começarei as inscrições de vocês as 15:00 da tarde. Ah e mais uma coisa, terá uma homenagem surpresa no campeonato, garanto que pelo estilo da nossa cidade vocês irão gostar, então participem, venham assistir, pois vai ser de arrepiar hehehehe!',
    ['2.5'] = 'E para finalizar os prêmios serão: O campeão vai ganhar um jogo da memória novinho, um troféu, uma medalha de ouro, uma bola de basquete, uma camisa de basquete homenagem, um brinde bem especial e um bom dinheiro. O segundo lugar irá ganhar uma medalha de prata, um jogo da memória novo, uma bola de basquete homenagem e uma quantia razoável de dinheiro. E o terceiro lugar ganhará uma medalha de bronze, um jogo da memória novo, uma camisa de basquete homenagem e uma quantia menor de dinheiro. Então, chega de papo e vamos se inscrever!',
