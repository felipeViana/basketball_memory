...
local music = assets.streetMusic
local background = assets.streetBackground

local function goToNextScreen()
  sceneManager.changeScene(require 'src/scenes/cutScene5-1')
end

function scene.load()
  local messages = messagesCreator.getMessage('4', goToNextScreen)
